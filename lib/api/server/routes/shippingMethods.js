...
var _shippingMethods = require('../services/orders/shippingMethods');
...
var ShippingMethodsRoute = (function() {
	function ShippingMethodsRoute(router) {
		_classCallCheck(this, ShippingMethodsRoute);
		this.router = router;
		this.registerRoutes();
	}
	_createClass(ShippingMethodsRoute, [
		{
			key: 'registerRoutes',
			value: function registerRoutes() {
				this.router.get(
					...
					_security2.default.checkUserScope.bind(
						this,
						_security2.default.scope.READ_SHIPPING_METHODS
					),
				...
				this.router.post(
					...
					_security2.default.checkUserScope.bind(
						this,
						_security2.default.scope.WRITE_SHIPPING_METHODS
					),
		...
		{
			key: 'deleteMethod',
			value: async function deleteMethod(req, res, next) {
				var result = await _shippingMethods2.default.deleteMethod(
					req.params.id
				);
	...
	return ShippingMethodsRoute;
})();
exports.default = ShippingMethodsRoute;
