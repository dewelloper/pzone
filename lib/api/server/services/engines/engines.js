...
var EnginesService = (function() {
	function EnginesService() {
		_classCallCheck(this, EnginesService);
	}
	_createClass(EnginesService, [
		{
			key: 'getEngines',
			value: async function getEngines() {
				var params =
					arguments.length > 0 && arguments[0] !== undefined
						? arguments[0]
						: {};
				var items = await _mongo.db.collection('tt_cars').distinct('type', {
					brand: params.marks,
					model: params.models,
...
exports.default = new EnginesService();
