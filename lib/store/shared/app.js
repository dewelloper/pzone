...
var SwitchContainers = (function(_React$Component) {
	...
	function SwitchContainers(props) {
		...
		return _possibleConstructorReturn(
			this,
			(
				SwitchContainers.__proto__ || Object.getPrototypeOf(SwitchContainers)
			).call(this, props)
		);
	}
...
var SwitchContainersConnected = (0, _reactRedux.connect)(
	mapStateToProps,
	mapDispatchToProps
)(SwitchContainers);
...
var App = function App() {
	return _react2.default.createElement(
		...
		_react2.default.createElement(_reactRouter.Route, {
			component: SwitchContainersConnected
		})
	);
};
exports.default = App;
