...
var getCurrentPage = function getCurrentPage(path) {
	return _api2.default.sitemap
		.retrieve({ path: path, enabled: true })
		.then(function(sitemapResponse) {
...
var getProducts = function getProducts(currentPage, productFilter) {
	if (
		currentPage.type === _pageTypes.PRODUCT_CATEGORY ||
		currentPage.type === _pageTypes.SEARCH
	) {
...
var getAllData = function getAllData(currentPage, productFilter, cookie) {
	return Promise.all([
		_api2.default.checkoutFields.list().then(function(_ref5) {
...
var getState = function getState(
	...
	var checkoutFields = allData.checkoutFields,
		...
		years = allData.years,
		engines = allData.engines,
		fuels = allData.fuels,
		pcategories = allData.pcategories;
...
var getFilter = function getFilter(currentPage, urlQuery, settings) {
	...
	if (currentPage.type === _pageTypes.PRODUCT_CATEGORY) {
		productFilter = (0, _actions.getProductFilterForCategory)(
			urlQuery,
...
var loadState = (exports.loadState = function loadState(req, language) {
	...
	return Promise.all([
		...
		_api2.default.settings.retrieve().then(function(_ref10) {
			var status = _ref10.status,
				json = _ref10.json;
			return json;
		}),
		themeLocales.getText(language),
		_api2.default.theme.placeholders.list()
		...
		return getAllData(currentPage, productFilter, cookie).then(function(
			allData
		) {
			var state = getState(
				currentPage,
