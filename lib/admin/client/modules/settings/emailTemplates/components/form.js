...
var EmailTemplate = (function(_React$Component) {
	...
	function EmailTemplate(props) {
		...
		return _possibleConstructorReturn(
			this,
			(EmailTemplate.__proto__ || Object.getPrototypeOf(EmailTemplate)).call(
				this,
				props
			)
		);
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_reduxForm.Field, {
									...
									fullWidth: true,
									name: 'subject',
									floatingLabelText: _text2.default.settings_emailSubject
								})
							),
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_reduxForm.Field, {
									...
									name: 'body',
									multiLine: true,
									floatingLabelText: _text2.default.settings_emailBody
								})
							)
						),
